...
**[v0.1.2](https://github.com/stoatworks-labs/flock/releases/tag/v0.1.2)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Apple Silicon · .dmg disk image (CLI) | [`flock-0.1.2-macos-aarch64-cli.dmg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-aarch64-cli.dmg) | 4.0 MB |
| Intel · .dmg disk image (CLI) | [`flock-0.1.2-macos-x86_64-cli.dmg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-x86_64-cli.dmg) | 4.1 MB |
| .dmg disk image (app) | [`flock-0.1.2-macos-app.dmg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-app.dmg) | 7.2 MB |
| Apple Silicon · .pkg installer (CLI) | [`flock-0.1.2-macos-aarch64-cli.pkg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-aarch64-cli.pkg) | 3.5 MB |
| Intel · .pkg installer (CLI) | [`flock-0.1.2-macos-x86_64-cli.pkg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-x86_64-cli.pkg) | 3.6 MB |
| .pkg installer (app) | [`flock-0.1.2-macos-app.pkg`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-macos-app.pkg) | 6.5 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`flock-0.1.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-windows-x86_64-setup.exe) | 2.5 MB |
| x64 · .exe installer | [`flock_0.1.2_x64-setup.exe`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock_0.1.3_x64-setup.exe) | 4.3 MB |
| ARM64 · .exe installer | [`flock-0.1.2-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-windows-aarch64-setup.exe) | 2.3 MB |
| x64 · .msi installer | [`flock_0.1.2_x64_en-US.msi`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock_0.1.3_x64_en-US.msi) | 6.3 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`flock_0.1.2_amd64.deb`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock_0.1.3_amd64.deb) | 8.0 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`flock_0.1.2_arm64.deb`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock_0.1.3_arm64.deb) | 4.1 MB |
| x64 · .rpm package (Fedora/RHEL) | [`flock-0.1.2-1.x86_64.rpm`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-1.x86_64.rpm) | 4.0 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`flock-0.1.2-1.aarch64.rpm`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock-0.1.3-1.aarch64.rpm) | 4.2 MB |
| x64 · AppImage | [`flock_0.1.2_amd64.AppImage`](https://github.com/stoatworks-labs/flock/releases/download/v0.1.3/flock_0.1.3_amd64.AppImage) | 79 MB |
